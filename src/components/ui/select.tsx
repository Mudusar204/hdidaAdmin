...
// import { Value } from "@/lib/interfaces";
...
// use combobox and above component style to make a searchable select with same design as above select
const SearchableSelect = ({
  ...
  return (
    <ReactSelect
      ...
      options={
        // make sure options should have max length of 3
        search
          ? options
              .filter((option: any) =>
